...
import { AddRequestLocation1740515720920 } from './migrations/1740515720920-AddRequestLocation';
...
export const AppDataSource = new DataSource({
  ...
  entities: [User, ApiKey, Widget, CrudPage, CrudData, AISettings, ErrorLog, SystemMetrics, SecurityEvent, RequestLocation],
  migrations: [
    ...
    AddRequestLocation1740515720920
  ],
  subscribers: [],
});
